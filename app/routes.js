...
// message board routes ===============================================================
    ...
    app.post('/messages', (req, res) => {
      db.collection('messages').save({name: req.body.name, order: req.body.order, thumbUp: 0, thumbDown:0}, (err, result) => {
        if (err) return console.log(err)
    ...
    //     $set: {
    //       thumbUp:req.body.thumbUp  order: req.body.order.style
    //     }
    //   }, {
    //     sort: {_id: -1},
    //     upsert: true
